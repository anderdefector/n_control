...
def dotMEX_gui():
    ...
    root = tk.Tk()
    Bebop_P4_support.set_Tk_var()
    top = Toplevel1 (root)
    Bebop_P4_support.init(root, top)
    rospy.init_node("dotMEXGUI", anonymous=False)
    rospy.Subscriber(topico_imagen, Image, Bebop_P4_support.receive)
    rospy.Subscriber("/bebop/odom", Odometry , Bebop_P4_support.receive_odom)
    rospy.Subscriber("/bebop/states/ardrone3/PilotingState/AltitudeChanged", Ardrone3PilotingStateAltitudeChanged, Bebop_P4_support.receive_altitud)
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    Bebop_P4_support.set_Tk_var()
    top = Toplevel1 (w)
    Bebop_P4_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.min1_sc.configure(variable=Bebop_P4_support.min1)
        ...
        self.min1_val_et.configure(textvariable=Bebop_P4_support.min1)
        ...
        self.min2_sc.configure(variable=Bebop_P4_support.min2)
        ...
        self.min2_val_et.configure(textvariable=Bebop_P4_support.min2)
        ...
        self.min3_sc.configure(variable=Bebop_P4_support.min3)
        ...
        self.min3_val_et.configure(textvariable=Bebop_P4_support.min3)
        ...
        self.max1_sc.configure(variable=Bebop_P4_support.max1)
        ...
        self.max1_val_et.configure(textvariable=Bebop_P4_support.max1)
        ...
        self.max2_sc.configure(variable=Bebop_P4_support.max2)
        ...
        self.max2_val_et.configure(textvariable=Bebop_P4_support.max2)
        ...
        self.max3_sc.configure(variable=Bebop_P4_support.max3)
        ...
        self.max3_val_et.configure(textvariable=Bebop_P4_support.max3)
        ...
        self.radio_sc.configure(variable=Bebop_P4_support.radio)
	self.radio_sc.set(80)
        ...
        self.radio_val_et.configure(textvariable=Bebop_P4_support.radio)
        ...
        self.cX_sc.configure(variable=Bebop_P4_support.cenX)
        self.cX_sc.set(320)
        ...
        self.cX_val_et.configure(textvariable=Bebop_P4_support.cenX)
        ...
        self.cY_sc.configure(variable=Bebop_P4_support.cenY)
	self.cY_sc.set(240)
        ...
        self.cY_val_et.configure(textvariable=Bebop_P4_support.cenY)
        ...
        self.modo_ch.configure(variable=Bebop_P4_support.modo_color)
        self.modo_ch.configure(command=Bebop_P4_support.change_mode)
        ...
        self.iniciar.configure(variable=Bebop_P4_support.inicio)
        self.iniciar.configure(command=Bebop_P4_support.inicio_fn)

        self.iniciar = tk.Checkbutton(top)
        self.iniciar.place(x=150, y=150, height=28, width=100)
        self.iniciar.configure(indicatoron="0")
        self.iniciar.configure(text='Take Off')
        #self.iniciar.configure(variable=Bebop_P4_support.inicio)
        #self.iniciar.configure(command=Bebop_P4_support.inicio_fn)

        self.iniciar = tk.Checkbutton(top)
        self.iniciar.place(x=150, y=200, height=28, width=100)
        self.iniciar.configure(indicatoron="0")
        self.iniciar.configure(text='Land')
        #self.iniciar.configure(variable=Bebop_P4_support.inicio)
        #self.iniciar.configure(command=Bebop_P4_support.inicio_fn)

        self.Guardar = tk.Button(top)
        self.Guardar.place(x=30, y=408, height=28, width=100)
        self.Guardar.configure(command=Bebop_P4_support.Guardar)
        ...
        self.sub_menu.add_command(label="Guardar", command=Bebop_P4_support.Guardar)
        self.sub_menu.add_command(label="Abrir", command=Bebop_P4_support.Abrir)
